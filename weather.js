...
const updateUI = (data) => {
    ...
    //weather.textContent = `
       // ${cityWeather.name} weather condition has ${cityWeather.weather[0].description} a wind speed of ${cityWeather.wind.speed}, with humidity ${cityWeather.main.humidity} and temperature of ${cityWeather.main.temp} F`
